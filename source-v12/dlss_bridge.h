...
public:
    ...
    // post-motion list after the NVOFA completion fence.
    void RecordPreMotion(ID3D12GraphicsCommandList*,ID3D12Resource*,UINT);
    void RecordPostMotion(ID3D12GraphicsCommandList*,ID3D12Resource*,UINT);
...
private:
    ...
    void SRV(ID3D12DescriptorHeap*,ID3D12Resource*,DXGI_FORMAT,UINT);
    void UAV(ID3D12DescriptorHeap*,ID3D12Resource*,DXGI_FORMAT,UINT);
};
